...
public class Frm_AddEdit extends JDialog  implements ActionListener {
	...
	public Frm_AddEdit(Bean_address b,Frm_Address f) {
		...
		getContentPane().add(buttonPane, BorderLayout.SOUTH);
			...
			con_name.setText(b.getCon_name());
			a_address.setText(b.getA_address());
