...
public class Frm_MenuEdit extends JDialog  implements ActionListener {
	...
	private Bean_menu curMenu=null;
	
	public Frm_MenuEdit(Frm_Menu f,Bean_menu curMenu) {
		this.f=f;
		...
		this.me_name.setText(curMenu.getMe_name());
		this.me_step.setText(curMenu.getMe_step());
		this.me_usage.setText(curMenu.getMe_usage());
		if(curMenu.getMe_picture()!=null) {
			this.picture=curMenu.getMe_picture();
		}
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.okButton) {
			...
			b.setMe_id(this.curMenu.getMe_id());
			}
			catch (Exception p){
			...
			start.Online_Market_Util.menu_manager.edit_menu(b);
			JOptionPane.showMessageDialog(null, "成功编辑菜谱", "成功", JOptionPane.INFORMATION_MESSAGE); 
