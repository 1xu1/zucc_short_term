...
public class Frm_ProEdit extends JDialog  implements ActionListener {
	...
	public Frm_ProEdit(Bean_production pro) {
		...
		getContentPane().add(buttonPane, BorderLayout.SOUTH);
			...
			getRootPane().setDefaultButton(okButton);
				...
				pro_name.setText(pro.getPro_name());
				pro_more.setText(pro.getPro_more());
				pro_price.setText(pro.getCell(1));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.okButton) {
			...
			start.Online_Market_Util.production_Manager.edit_pro(b);
			JOptionPane.showMessageDialog(null, "成功", "成功编辑商品", JOptionPane.INFORMATION_MESSAGE); 
