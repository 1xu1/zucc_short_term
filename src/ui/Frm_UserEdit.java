...
public class Frm_UserEdit extends JDialog  implements ActionListener{
	...
	public Frm_UserEdit(JFrame f,String s, Boolean c) {
		setTitle("\u7F16\u8F91\u6307\u5B9A\u7528\u6237\u4FE1\u606F");
		//super(f,s,c);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.okButton) {
			try {
				...
				JOptionPane.showMessageDialog(null, "请检查输入格式", "错误", JOptionPane.INFORMATION_MESSAGE);
				return;
			}
			JOptionPane.showMessageDialog(null, "制定用户信息成功修改", "成功", JOptionPane.INFORMATION_MESSAGE);
		}
